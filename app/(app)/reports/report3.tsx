          ...
          <>
            <View style={[styles.tabBar, { borderBottomColor: p.border }]}>
              <TouchableOpacity onPress={() => setTab('circle')} style={[styles.tab, tab === 'circle' && { borderBottomColor: p.primary, borderBottomWidth: 2 }]}>
                <Text style={{ fontSize: 14, fontWeight: '700', color: tab === 'circle' ? p.primary : p.textMuted }}>Circle Wise Variety</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setTab('moza')} style={[styles.tab, tab === 'moza' && { borderBottomColor: p.primary, borderBottomWidth: 2 }]}>
                <Text style={{ fontSize: 14, fontWeight: '700', color: tab === 'moza' ? p.primary : p.textMuted }}>Moza Wise Variety</Text>
              </TouchableOpacity>
            </View>

            {tab === 'circle' ? (
              <Card>
                <SectionTitle title="Circle Wise Variety Summary" subtitle="Variety / Non-Variety Mondha & Sanma per circle" />
              ...
              <Card>
                <SectionTitle title="Moza Wise Variety Summary" subtitle="Grouped by circle with circle subtotals and grand total" />
